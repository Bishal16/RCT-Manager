...
//                bridgeCall(ctx.getChannel(), event);
                String unique_id = event.getEventHeaders().get("Unique-ID");
                String cmd = "uuid_transfer unique_id 1002 XML after_esl";
...
//        }
        ...
        ConcurrentCall cc = new ConcurrentCall();
        Map<String, String> map = event.getEventHeaders();

//        cc.concurrentCall.put(uuid, new UserRegistrationInfo(event));
...
//        extNums.add("10");
        ...
        bridgeMsg.addExecuteAppArg("sofia/external/sip:192.168.0.141/"+calledNumber );
